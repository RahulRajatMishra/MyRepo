...
public class VerifyMonthlyEssentialUserCreation extends BaseClass {

	@Test(priority = 1, groups= {"Smoke"}, description = "Monthly_Plan_Essential_User_Account_Creation")
	public void verifyMonthlyEssentialUserCreation() throws Exception
	{
...
//		accountPage.getContinuebtn().click();
		...
		LoggerUtility.info("New Monthly Essential account is created");
	}
	@Test(priority = 2,groups= {"Smoke"}, description = "Monthly_Plan_Essential_User_Make_Payment")
	public void makePayment()
	{
		...
		LoggerUtility.info("New Monthly Premium account- Payment Done");
	}
}
