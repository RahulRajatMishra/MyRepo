...
public class VerifyAnnualEssentialUserCreation extends BaseClass {

	@Test(priority = 1, groups= {"Smoke"}, description = "Annual_Plan_Paramount+Essential_User_Account_Creation")
	public void verifyAnnualEssentialUserCreation() throws Exception
	{
		...
		boolean flag3= pickPlanPage.getAnnualEssentialPlanPrice().isDisplayed();
...
//		accountPage.getContinuebtn().click();
		...
		LoggerUtility.info("New Annual Essential account is created");
	}
	@Test(priority = 2,groups= {"Smoke"}, description = "Annual_Plan_Paramount+Essential_User_Make_Payment")
	public void makePayment()
	{
		...
		LoggerUtility.info("New Annual Essentail account- Payment Done");
	}	
}
